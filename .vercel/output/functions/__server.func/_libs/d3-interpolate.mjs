import { color, constant_default$1 as constant_default, hue, nogamma, number_default, rgb_default, string_default } from "./@streamdown/mermaid+[...].mjs";
import { hcl as hcl$1 } from "./d3-color.mjs";
...
//#endregion
export { hcl_default, round_default, value_default };
