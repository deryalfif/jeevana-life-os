import { APICallError, InvalidPromptError, InvalidResponseDataError, TooManyEmbeddingValuesForCallError, UnsupportedFunctionalityError, ZodNumber, _coercedNumber, _enum, _null, any, array, boolean, combineHeaders, convertBase64ToUint8Array, convertToBase64, convertToFormData, createBinaryResponseHandler, createEventSourceResponseHandler, createJsonErrorResponseHandler, createJsonResponseHandler, createProviderToolFactory, createProviderToolFactoryWithOutputSchema, createToolNameMapping, discriminatedUnion, downloadBlob, generateId, isNonNullable, isParsableJson, lazy, lazySchema, literal, loadApiKey, loadOptionalSetting, mediaTypeToExtension, number as number$1, object, parseJSON, parseProviderOptions, postFormDataToApi, postJsonToApi, record, string, union, unknown, validateTypes, withUserAgentSuffix, withoutTrailingSlash, zodSchema } from "./@ai-sdk/gateway+[...].mjs";
