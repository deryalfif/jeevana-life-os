...
import { require_dist } from "../braintree__sanitize-url.mjs";
import { getIconData, iconToHTML, iconToSVG, replaceIDs, stringToIcon } from "../iconify__utils.mjs";
...
var mix = (color1, color2, weight = 50) => {
	...
	return rgba$1(r1 * weight1 + r2 * weight2, g1 * weight1 + g2 * weight2, b1 * weight1 + b2 * weight2, a1 * weightScale + a2 * (1 - weightScale));
};
//#endregion
...
var Theme2 = class {
	...
	constructor() {
		...
		this.border1 = "#ccc";
		this.border2 = rgba$1(255, 255, 255, .25);
...
var Theme3 = class {
	...
	constructor() {
		...
		this.sectionBkgColor = rgba$1(102, 102, 255, .49);
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
	...
	{
		const { default: katex } = await import("./math+[...].mjs").then((n) => n.katex_exports);
...
function styleMaybeRemove(id, name) {
	...
	return function() {
		var schedule = set$1(this, id), on = schedule.on, listener = schedule.value[key] == null ? remove || (remove = styleRemove(name)) : void 0;
...
var { abs: abs$2, max: max$1, min: min$1 } = Math;
["w", "e"].map(type$1);
["n", "s"].map(type$1);
[
	"n",
...
function line_default(x, y) {
	...
	x = typeof x === "function" ? x : x === void 0 ? x$2 : constant_default(x);
	y = typeof y === "function" ? y : y === void 0 ? y$2 : constant_default(y);
	function line(data) {
	...
	line.x = function(_) {
		return arguments.length ? (x = typeof _ === "function" ? _ : constant_default(+_), line) : x;
	};
	line.y = function(_) {
		return arguments.length ? (y = typeof _ === "function" ? _ : constant_default(+_), line) : y;
	};
...
var selectSvgElement = /* @__PURE__ */ __name((id) => {
	...
	let root = select_default$1("body");
	if (securityLevel === "sandbox") root = select_default$1((select_default$1(`#i${id}`).node()?.contentDocument ?? document).body);
	...
	return {
		x: /* @__PURE__ */ __name(function(d, i, data) {
			...
			if (i === 0 && Object.hasOwn(markerOffsets, edge.arrowTypeStart)) {
				...
				const { angle, deltaX } = calculateDeltaAndAngle$1(data[data.length - 1], data[data.length - 2]);
		...
		y: /* @__PURE__ */ __name(function(d, i, data) {
			...
			if (i === 0 && Object.hasOwn(markerOffsets, edge.arrowTypeStart)) {
				...
				const { angle, deltaY } = calculateDeltaAndAngle$1(data[data.length - 1], data[data.length - 2]);
...
var calculateTextDimensions = memoize((text, config) => {
	...
	const dims = [];
	const body = select_default$1("body");
...
function d$1(l, e = "") {
	let t = typeof l == "string" ? l : l.source, n = {
		replace: (r, i) => {
			...
			return s = s.replace(m$2.caret, "$1"), t = t.replace(r, s), n;
		},
...
var be = (() => {
	...
	table: E$1,
	text: Pe
}, re = d$1("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", I$1).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v$1).getRegex(), Me = {
	...K$1,
	lheading: ye,
	table: re,
	paragraph: d$1(j$1).replace("hr", I$1).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", re).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", v$1).getRegex()
}, ze = {
	...K$1,
	...
	text: d$1(N$1.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
}, C$1 = {
	normal: K$1,
	gfm: Me,
	pedantic: ze
...
function w$1(l, e) {
	if (e) {
		if (m$2.escapeTest.test(l)) return l.replace(m$2.escapeReplace, ge);
	} else if (m$2.escapeTestNoEncode.test(l)) return l.replace(m$2.escapeReplaceNoEncode, ge);
	return l;
}
function J$1(l) {
	try {
		l = encodeURI(l).replace(m$2.percentDecode, "%");
	} catch {
		return null;
	}
	return l;
...
function V$1(l, e) {
	let n = l.replace(m$2.findPipe, (i, s, a) => {
		let o = !1, p = s;
		for (; --p >= 0 && a[p] === "\\";) o = !o;
		return o ? "|" : " |";
	}).split(m$2.splitPipe), r = 0;
	if (n[0].trim() || n.shift(), n.length > 0 && !n.at(-1)?.trim() && n.pop(), e) if (n.length > e) n.splice(e);
	else for (; n.length < e;) n.push("");
	for (; r < n.length; r++) n[r] = n[r].trim().replace(m$2.slashPipe, "|");
	return n;
}
function z$1(l, e, t) {
	let n = l.length;
	...
	code(e) {
		...
		if (t) {
			...
			return {
				...
				text: this.options.pedantic ? n : z$1(n, `
`)
			};
		}
	}
...
`, e = e.substring(Z.length + 1), g = A.slice(f);
	...
	table(e) {
		...
		let n = V$1(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], s = {
			type: "table",
			raw: t[0],
			header: [],
		...
		if (n.length === r.length) {
			...
			for (let a of i) s.rows.push(V$1(a, s.header.length).map((o, p) => ({
				text: o,
...
var x$1 = class l {
	...
	inlineQueue;
	constructor(e) {
		this.tokens = [], this.tokens.links = Object.create(null), this.options = e || T$1, this.options.tokenizer = this.options.tokenizer || new y$1(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
			inLink: !1,
			inRawBlock: !1,
			top: !0
		};
		...
		this.options.pedantic ? (t.block = C$1.pedantic, t.inline = M$1.pedantic) : this.options.gfm && (t.block = C$1.gfm, this.options.breaks ? t.inline = M$1.breaks : t.inline = M$1.gfm), this.tokenizer.rules = t;
	}
	static get rules() {
		return {
			block: C$1,
	...
	lex(e) {
		e = e.replace(m$2.carriageReturn, `
`), this.blockTokens(e, this.tokens);
	...
	blockTokens(e, t = [], n = !1) {
		for (this.options.pedantic && (e = e.replace(m$2.tabCharGlobal, "    ").replace(m$2.spaceLine, "")); e;) {
			let r;
...
var P$1 = class {
	...
	code({ text: e, lang: t, escaped: n }) {
		let r = (t || "").match(m$2.notSpaceStart)?.[0], i = e.replace(m$2.endingNewline, "") + `
`;
		return r ? "<pre><code class=\"language-" + w$1(r) + "\">" + (n ? i : w$1(i, !0)) + `</code></pre>
` : "<pre><code>" + (n ? i : w$1(i, !0)) + `</code></pre>
`;
	}
	blockquote({ tokens: e }) {
		return `<blockquote>
...
`;
	...
	listitem(e) {
		...
		if (e.task) {
			...
			e.loose ? e.tokens[0]?.type === "paragraph" ? (e.tokens[0].text = n + " " + e.tokens[0].text, e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && e.tokens[0].tokens[0].type === "text" && (e.tokens[0].tokens[0].text = n + " " + w$1(e.tokens[0].tokens[0].text), e.tokens[0].tokens[0].escaped = !0)) : e.tokens.unshift({
				type: "text",
				raw: n + " ",
				text: n + " ",
				escaped: !0
...
`;
	...
	link({ href: e, title: t, tokens: n }) {
		let r = this.parser.parseInline(n), i = J$1(e);
		if (i === null) return r;
		e = i;
		let s = "<a href=\"" + e + "\"";
...
var b$1 = class l {
	...
	textRenderer;
	constructor(e) {
		this.options = e || T$1, this.options.renderer = this.options.renderer || new P$1(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new $$1();
	}
	static parse(e, t) {
	...
	use(...e) {
		...
		return e.forEach((n) => {
			...
			if (r.async = this.defaults.async || r.async || !1, n.extensions && (n.extensions.forEach((i) => {
				...
				let i = this.defaults.renderer || new P$1(this.defaults);
			...
			if (n.tokenizer) {
				let i = this.defaults.tokenizer || new y$1(this.defaults);
			...
			if (n.hooks) {
				...
				for (let s in n.hooks) {
					...
					S$1.passThroughHooks.has(s) ? i[a] = (u) => {
						if (this.defaults.async && S$1.passThroughHooksRespectAsync.has(s)) return (async () => {
...
Please report this to https://github.com/markedjs/marked.`, e) {
				let r = "<p>An error occurred:</p><pre>" + w$1(n.message + "", !0) + "</pre>";
...
var _$1 = new B$1();
function k$1(l, e) {
	return _$1.parse(l, e);
}
k$1.options = k$1.setOptions = function(l) {
	return _$1.setOptions(l), k$1.defaults = _$1.defaults, G$1(k$1.defaults), k$1;
};
k$1.getDefaults = L$1;
k$1.defaults = T$1;
k$1.use = function(...l) {
	return _$1.use(...l), k$1.defaults = _$1.defaults, G$1(k$1.defaults), k$1;
};
k$1.walkTokens = function(l, e) {
	return _$1.walkTokens(l, e);
};
...
var createText = /* @__PURE__ */ __name(async (el, text = "", { style = "", isTitle = false, classes = "", useHtmlLabels = true, markdown = true, isNode = true, width = 200, addSvgBackground = false } = {}, config) => {
	...
	if (useHtmlLabels) {
		...
		if (isNode) {
			...
			select_default$1(svgLabel).attr("style", nodeLabelTextStyle);
		} else {
			const edgeLabelRectStyle = style.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/background:/g, "fill:");
			select_default$1(svgLabel).select("rect").attr("style", edgeLabelRectStyle.replace(/background:/g, "fill:"));
			const edgeLabelTextStyle = style.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
			select_default$1(svgLabel).select("text").attr("style", edgeLabelTextStyle);
		}
		if (isTitle) select_default$1(svgLabel).selectAll("tspan.text-outer-tspan").classed("title-row", true);
		else select_default$1(svgLabel).selectAll("tspan.text-outer-tspan").classed("row", true);
		return svgLabel;
	}
}, "createText");
//#endregion
	...
	return function(t, e) {
		...
		if (!u[s]) switch (s) {
			...
			case "zigzag-line":
				u[s] || (u[s] = new l(e));
				break;
			default: s = "hachure", u[s] || (u[s] = new o$1(e));
		}
		return u[s];
...
var labelHelper = /* @__PURE__ */ __name(async (parent, node, _classes) => {
	...
	if (useHtmlLabels) {
		...
		const dv = select_default$1(text2);
...
async function rectWithTitle(parent, node) {
	...
	if (getEffectiveHtmlLabels(getConfig2())) {
		...
		const dv2 = select_default$1(text2);
	...
	const dv = select_default$1(descr);
	bbox = div.getBoundingClientRect();
	dv.attr("width", bbox.width);
	dv.attr("height", bbox.height);
	const halfPadding = (node.padding || 0) / 2;
	select_default$1(descr).attr("transform", "translate( " + (bbox.width > titleBox.width ? 0 : (titleBox.width - bbox.width) / 2) + ", " + (titleBox.height + halfPadding + 5) + ")");
	select_default$1(text2).attr("transform", "translate( " + (bbox.width < titleBox.width ? 0 : -(titleBox.width - bbox.width) / 2) + ", 0)");
...
async function erBox(parent, node) {
	...
	shapeSvg.selectAll("g:not(:first-child)").each((_, i, nodes) => {
		const text2 = select_default$1(nodes[i]);
...
async function addText2(parentGroup, node, yOffset, styles = []) {
	...
	let numberOfLines = 1;
	if (!useHtmlLabels) {
		if (styles.includes("font-weight: bolder")) select_default$1(text2).selectAll("tspan").attr("font-weight", "");
...
var insertEdgeLabel = /* @__PURE__ */ __name(async (elem, edge) => {
	...
	if (useHtmlLabels) {
		...
		const dv = select_default$1(labelElement);
		bbox = div.getBoundingClientRect();
		transformBbox = bbox;
		dv.attr("width", bbox.width);
		dv.attr("height", bbox.height);
	} else {
		const textEl = select_default$1(labelElement).select("text").node();
	...
	if (edge.startLabelLeft) {
		...
		if (useHtmlLabels) {
			...
			const dv = select_default$1(startLabelElement);
	...
	if (edge.endLabelLeft) {
		...
		if (useHtmlLabels) {
			...
			const dv = select_default$1(endLabelElement);
			slBox = div.getBoundingClientRect();
			dv.attr("width", slBox.width);
			dv.attr("height", slBox.height);
		}
...
var insertEdge = /* @__PURE__ */ __name(function(elem, edge, clusterDb, diagramType, startNode, endNode, diagramId, skipIntersect = false) {
	...
	if (edge.look === "handDrawn") {
		...
		svgPath = select_default$1(svgPathNode).select("path").attr("id", `${diagramId}-${edge.id}`).attr("class", " " + strokeClasses + (edge.classes ? " " + edge.classes : "") + (animationClass ? " " + animationClass : "")).attr("style", edgeStyles ? edgeStyles.reduce((acc, style) => acc + ";" + style, "") : "");
...
(/* @__PURE__ */ __name(() => {
	registerLayoutLoaders([{
		name: "dagre",
		loader: /* @__PURE__ */ __name(async () => await import("../mermaid+uuid.mjs").then((n) => n.dagre_BM42HDAG_exports), "loader")
	}, ...[{
		name: "cose-bilkent",
		loader: /* @__PURE__ */ __name(async () => await import("../mermaid+uuid.mjs").then((n) => n.cose_bilkent_S5V4N54A_exports), "loader")
	}]]);
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.c4Diagram_AAUBKEIU_exports);
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.flowDiagram_I6XJVG4X_exports);
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.erDiagram_TEJ5UH35_exports);
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.gitGraphDiagram_PVQCEYII_exports);
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.ganttDiagram_6RSMTGT7_exports);
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.infoDiagram_5YYISTIA_exports);
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.pieDiagram_4H26LBE5_exports);
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.quadrantDiagram_W4KKPZXB_exports);
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.xychartDiagram_2RQKCTM6_exports);
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.requirementDiagram_4Y6WPE33_exports);
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.sequenceDiagram_3UESZ5HK_exports);
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.classDiagram_4FO5ZUOK_exports);
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.classDiagram_v2_Q7XG4LA2_exports);
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.stateDiagram_AJRCARHV_exports);
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.stateDiagram_v2_BHNVJYJU_exports);
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.journeyDiagram_JHISSGLW_exports);
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.timeline_definition_PNZ67QCA_exports);
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.mindmap_definition_RKZ34NQL_exports);
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.kanban_definition_UN3LZRKU_exports);
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.sankeyDiagram_5OEKKPKP_exports);
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.diagram_LMA3HP47_exports);
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.diagram_2AECGRRQ_exports);
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.blockDiagram_GPEHLZMM_exports);
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.diagram_5GNKFQAL_exports);
		return {
			id: id26,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.architectureDiagram_3BPJPVTR_exports);
		return {
			id: id27,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.diagram_KO2AKTUF_exports);
		return {
			id: id28,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.ishikawaDiagram_YF4QCWOH_exports);
		return {
			id: id29,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.vennDiagram_CIIHVFJN_exports);
		return {
			id: id30,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.diagram_OG6HWLK6_exports);
		return {
			id: id31,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("../mermaid+uuid.mjs").then((n) => n.wardleyDiagram_YWT4CUSO_exports);
		return {
			id: id32,
			diagram: diagram2
		};
...
var render = /* @__PURE__ */ __name(async function(id33, text, svgContainingElement) {
	...
	const removeTempElements = /* @__PURE__ */ __name(() => {
		const node = select_default$1(isSandboxed ? iFrameID_selector : enclosingDivID_selector).node();
		if (node && "remove" in node) node.remove();
	}, "removeTempElements");
	let root = select_default$1(document.body);
	...
	if (svgContainingElement !== void 0) {
		...
		if (isSandboxed) {
			root = select_default$1(sandboxedIframe(select_default$1(svgContainingElement), iFrameID).nodes()[0].contentDocument.body);
			root.node().style.margin = "0";
		} else root = select_default$1(svgContainingElement);
		...
		if (isSandboxed) {
			root = select_default$1(sandboxedIframe(select_default$1(document.body), iFrameID).nodes()[0].contentDocument.body);
			root.node().style.margin = "0";
		} else root = select_default$1("body");
...
*/
//#endregion
//#region node_modules/@streamdown/mermaid/dist/index.js
var m = {
	startOnLoad: false,
	theme: "default",
	securityLevel: "strict",
	...
	let e = false, r = {
		...
		initialize(i) {
			r = {
				...
				...a.config,
				...i
			}, mermaid_default.initialize(r), e = true;
		},
		async render(i, g) {
...
var f = o();
//#endregion
export { Color, Color$1, JSON_SCHEMA, Rgb, Utils, __export, __name, abs$1 as abs, acos, adjustChannel, argumentsTag, arrayBufferTag, arrayTag, array_default, asin, assignWithDepth_default, at, atan2, basis_default, booleanTag, calculateMathMLDimensions, calculateTextDimensions, calculateTextHeight, calculateTextWidth, cleanAndMerge, clear, clear$1, clear$2, clear2, color, commonDb_exports, common_default, computeDimensionOfText, computeLabelTransform, configureLabelImages, configureSvgSize, constant_default, constant_default$1, cos, createText, darken, dataViewTag, dateTag, decodeEntities, defaultConfig2, defaultConfig_default, define_default, epsilon, extend$1 as extend, f, float32ArrayTag, float64ArrayTag, generateId, getAccDescription, getAccTitle, getConfig, getConfig2, getDiagramTitle, getEdgeId, getEffectiveHtmlLabels, getIconSVG, getLineFunctionsWithOffset, getRegisteredLayoutAlgorithm, getStylesFromArray, getSubGraphTitleMargins, getTag, getThemeVariables3, getUrl, getUserDefinedConfig, halfPi, hasKatex, hue, insertCluster, insertEdge, insertEdgeLabel, insertNode, int16ArrayTag, int32ArrayTag, int8ArrayTag, isDark, isLabelStyle, isPrimitive, isTypedArray, isValidShape, lighten, lineBreakRegex, line_default, load, log, mapTag, markers_default, max, min, nogamma, numberTag, number_default, objectTag, parseFontSize, parseGenericTypes, pi, positionEdgeLabel, positionNode, purify, random, regexpTag, registerIconPacks, render$1 as render, renderKatexSanitized, require_dayjs_min, rgbConvert, rgb_default, rgba$1 as rgba, sanitizeText, selectSvgElement, select_default$1 as select_default, setAccDescription, setAccTitle, setConfig2, setDiagramTitle, setNodeElem, setTag, setupGraphViewbox, setupGraphViewbox2, sin, sqrt, stringTag, string_default, styles2String, symbolTag, tau, uint16ArrayTag, uint32ArrayTag, uint8ArrayTag, uint8ClampedArrayTag, unknownIcon, updateNodeBounds, utils_default, withPath, wrapLabel };
